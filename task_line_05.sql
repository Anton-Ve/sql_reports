...
tt.pu,
t.t1,
case when tt.pok1='30' then 'Системный расчет' 
      when tt.pok1='60'  then 'Обычное показание' 
       when tt.pok1='45' then 'Перерассчитано системой' end as descr1,    
t.t2,
case when tt.pok2='30' then 'Системный расчет' 
      when tt.pok2='60'  then 'Обычное показание' 
       when tt.pok2='45' then 'Перерассчитано системой' end as descr2,
t.t3,
case when tt.pok3='30' then 'Системный расчет' 
      when tt.pok3='60'  then 'Обычное показание' 
       when tt.pok3='45' then 'Перерассчитано системой' end as descr3,
t.t4,
case when tt.pok4='30' then 'Системный расчет' 
      when tt.pok4='60'  then 'Обычное показание' 
       when tt.pok4='45' then  'Перерассчитано системой' end as descr4,
t.t5,
case when tt.pok5='30' then 'Системный расчет' 
      when tt.pok5='60'  then 'Обычное показание' 
       when tt.pok5='45' then  'Перерассчитано системой' end as descr5,
t.t6,
case when tt.pok6='30' then 'Системный расчет' 
      when tt.pok6='60'  then 'Обычное показание' 
       when tt.pok6='45' then  'Перерассчитано системой' end as descr6,
t.t7,
case when tt.pok7='30' then 'Системный расчет' 
      when tt.pok7='60'  then 'Обычное показание' 
       when tt.pok7='45' then  'Перерассчитано системой' end as descr7,
t.t8,
case when tt.pok8='30' then 'Системный расчет' 
      when tt.pok8='60'  then 'Обычное показание' 
       when tt.pok8='45' then  'Перерассчитано системой' end as descr8,
t.t9,
case when tt.pok9='30' then 'Системный расчет' 
      when tt.pok9='60'  then 'Обычное показание' 
       when tt.pok9='45' then 'Перерассчитано системой' end as descr9,
t.kol_top2,
t.kol_top3,
t.fias,
t.bild
